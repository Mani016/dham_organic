            ...
            <div className="widget">
              ...
              <div className="footer_p">
                ...
                <p className="footer_para">
                  Our aim is to perform sustainable agriculture, producing
                  high-quality products by the use of processes that do not harm
                  the environment, nor human, plant or animal health and
                  welfare.
                </p>
              </div>
          ...
          <div className="col-lg-2 col-sm-12">
            <div className="widget quick_lnk">
              ...
              <ul>
                ...
                <li>
                  <Link to={process.env.PUBLIC_URL + "/about-us/dhaam-story"}>
                    Dhaam Story
                  </Link>
                </li>
                <li>
