...
export const  GALLERY_TYPES = [
  { key: "landscape", label: "Landscape", desc:"Dhaam Farms are located amidst nature and all its bounty. The farms are in Chhudani Village of District Jhajjar, Village Malikpur and Dhansa near Delhi Haryana Border.\n" +
  ...
  { key: "training-expansion", label: "Training and Expansion" , desc: "\n" +
  ...
  { key: "events", label: "Events"  , desc:"At Dhaam we try to involve all people from the laborers of farm to our customers in the process of farming. \n" +
  ...
  { key: "showcase", label: "Showcase" , desc: "Dhaam Organic has been a proud and honoured participant in many demonstrations in\n" +
