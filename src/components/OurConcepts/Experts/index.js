        ...
        const teamlistarray = [
            {
                ...
                desc:'Getting the certification is one of the important steps in starting the organic farming. So, when we wanted to start organic farming to cater to the domestic need for organic produce, we contacted Dr. Rishi who provided us with PGS Certification for Organic Farming.\n' +
            ...
            },
            {
                ...
                desc:'Dr. Dharmesh Verma provides us with his valuable inputs in the day to day obstacles that arise in the fields with crops and other related issues.\n' +
                    ...
                    'He has helped us in preparing two important lifelines of Organic Farming \n' +
                    '1) Jeevamrit, a microbial culture, prepared especially from dung and urine of Indian cow is generally advocated for use in organic farming to meet nutritional requirement of crops \n' +
                    '2) Panchagavya, an organic product that has the potential to play the role of promoting growth and providing immunity in plant system.'
            }
        ]
